...
public class UsersPanel extends JFrame {
    ...
    private void OpenAddUserRelationWindow() { // ABRE LA VENTANA AGREGAR RELACION 
        setVisible(false);
        ...
        AddUserRelationsWindow.addWindowListener(new WindowAdapter() { // ABRE LA VENTANA CON LOS USUARIOS YA RELEACIONADOS
            @Override
